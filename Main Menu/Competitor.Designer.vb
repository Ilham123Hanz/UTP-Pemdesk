...
Partial Class Competitor
    ...
    Private Sub InitializeComponent()
        ...
        CType(lstTeams, ComponentModel.ISupportInitialize).BeginInit()
        ...
        ' 
        pnlMainGridContainer.Controls.Add(lstTeams)
        ...
        ' lstTeams
        ' 
        lstTeams.BackgroundColor = Color.White
        ...
        lstTeams.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle3
        lstTeams.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
        lstTeams.Columns.AddRange(New DataGridViewColumn() {colEmpty1, colEmpty2, colEmpty3, colName, colTeam, colTeamInfo, colCompPict})
        ...
        lstTeams.DefaultCellStyle = DataGridViewCellStyle4
        lstTeams.Dock = DockStyle.Left
        lstTeams.Location = New Point(224, 0)
        lstTeams.Margin = New Padding(4)
        lstTeams.Name = "lstTeams"
        lstTeams.RowHeadersVisible = False
        lstTeams.RowHeadersWidth = 62
        lstTeams.RowTemplate.Height = 60
        lstTeams.Size = New Size(1314, 463)
        lstTeams.TabIndex = 1
        ' 
        ' colEmpty1
        ' 
        ...
        pnlLeftTeam.Controls.Add(listTeams)
        ...
        ' listTeams
        ' 
        listTeams.Dock = DockStyle.Left
        listTeams.FormattingEnabled = True
        listTeams.Location = New Point(0, 38)
        listTeams.Name = "listTeams"
        listTeams.Size = New Size(224, 423)
        ...
        CType(lstTeams, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents lstTeams As System.Windows.Forms.DataGridView
    ...
    Friend WithEvents listTeams As ListBox
