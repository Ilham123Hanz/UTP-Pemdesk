...
Partial Class dashboard
    ...
    Private Sub InitializeComponent()
        ...
        ' pnlKumite
        ' 
        pnlKumite.BackColor = Color.Transparent
        ...
        lblKumite.Location = New Point(0, 130)
        lblKumite.Name = "lblKumite"
        lblKumite.Size = New Size(160, 30)
        ...
        ' pnlKata
        ' 
        pnlKata.BackColor = Color.Transparent
        ...
        lblKata.Location = New Point(0, 130)
        lblKata.Name = "lblKata"
        lblKata.Size = New Size(160, 30)
        lblKata.TabIndex = 1
        lblKata.Text = "KATA"
        ...
        ' pnlMatchResult
        ' 
        pnlMatchResult.BackColor = Color.Transparent
        ...
        lblMatchResult.Location = New Point(0, 130)
        lblMatchResult.Name = "lblMatchResult"
        lblMatchResult.Size = New Size(160, 30)
